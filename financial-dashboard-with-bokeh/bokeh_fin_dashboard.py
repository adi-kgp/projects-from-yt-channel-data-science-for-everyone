...
def load_ticker(tickers):
    df = yf.download(tickers=DEFAULT_TICKERS, start=START, end=END)
...
corr.scatter("t1_returns", "t2_returns", size=2, source=source, selection_color="firebrick", alpha=0.6, nonselection_alpha=0.1, selection_alpha=0.4)
